...
public class NotAssignablePhoneBadRequestException extends DefaultBadRequestException {
    @Serial
    private static final long serialVersionUID = -2634323841999847616L;

    public NotAssignablePhoneBadRequestException(UUID id, UUID user_id) {
