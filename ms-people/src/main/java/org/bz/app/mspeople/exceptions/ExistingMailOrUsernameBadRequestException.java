...
public class ExistingMailOrUsernameBadRequestException extends DefaultBadRequestException {

    @Serial
    private static final long serialVersionUID = -7241642475224506375L;

    public ExistingMailOrUsernameBadRequestException(String email, String username, boolean equals) {
        super("The "
