...
INSERT INTO AUTHORITY_SECURITIES (id, authority) VALUES(UUID(), 'EDIT_ALL');
INSERT INTO AUTHORITY_SECURITIES (id, authority) VALUES(UUID(), 'DELETE_ALL');
INSERT INTO AUTHORITY_SECURITIES (id, authority) VALUES(UUID(), 'READ_SELF');
INSERT INTO AUTHORITY_SECURITIES (id, authority) VALUES(UUID(), 'EDIT_SELF');
...
INSERT INTO ROLE_AUTHORITY_MAPPING (authority_id, role_id) VALUES ( (SELECT id FROM AUTHORITY_SECURITIES WHERE authority = 'EDIT_ALL'),(SELECT id FROM ROLE_SECURITIES WHERE name = 'ADMIN'));
INSERT INTO ROLE_AUTHORITY_MAPPING (authority_id, role_id) VALUES ( (SELECT id FROM AUTHORITY_SECURITIES WHERE authority = 'DELETE_ALL'),(SELECT id FROM ROLE_SECURITIES WHERE name = 'ADMIN'));
...
INSERT INTO ROLE_AUTHORITY_MAPPING (authority_id, role_id) VALUES ( (SELECT id FROM AUTHORITY_SECURITIES WHERE authority = 'EDIT_SELF'),(SELECT id FROM ROLE_SECURITIES WHERE name = 'ADMIN'));
...
INSERT INTO ROLE_AUTHORITY_MAPPING (authority_id, role_id) VALUES ( (SELECT id FROM AUTHORITY_SECURITIES WHERE authority = 'EDIT_SELF'),(SELECT id FROM ROLE_SECURITIES WHERE name = 'USER'));
...
-- Para ejecutar SELECT * FROM ROLE_SECURITIES
-- Para ejectuar SELECT * FROM AUTHORITY_SECURITIES
-- Para ejecutar SELECT * FROM ROLE_AUTHORITY_MAPPING